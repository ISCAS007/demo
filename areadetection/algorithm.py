...
from utils.utils import load_classes, non_max_suppression, scale_coords, plot_one_box, bbox_iou
from utils.parse_config import parse_data_cfg
from utils.torch_utils import select_device

#from model.yolov3.utils.utils import bbox_iou,non_max_suppression
from split_image_utils import split_image,yolov3_loadImages
...
class yolov3_slideWindows(yolov3_loadImages):
    def __init__(self,opt):
        ...
        self.opt=opt
        names_path=parse_data_cfg(opt.data_cfg)['names']
        if not os.path.exists(names_path):
            names_path=os.path.join(opt.root_path,names_path)
